...
export interface LiquidityPool {
  ...
  algoReserve: number // ALGO reserve in pool
...
export interface LiquidityPosition {
  ...
  algoAmount: number // User's ALGO contribution
...
export class LiquidityPoolService {
  ...
  /**
   * Swap tokens for ALGO (sell tokens)
   */
  static swapTokensForAlgo(
    ...
    // Calculate ALGO output using constant product formula
  ...
  /**
   * Swap ALGO for tokens (buy tokens)
   */
  ...
  static estimateSwap(
    pool: LiquidityPool,
    inputAmount: number,
    isBuying: boolean // true = buying tokens with ALGO, false = selling tokens for ALGO
  ): {
    outputAmount: number
    priceImpact: number
    newPrice: number
