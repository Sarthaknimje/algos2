...
const Home: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: 'Transform your YouTube videos, Instagram reels, Twitter tweets, and LinkedIn posts into tradeable digital assets on Algorand blockchain.',
  ...
  const liveStats = [
    { label: 'Tokens Created', value: '1,247+', icon: Coins, change: '+12%', positive: true },
    { label: 'Active Creators', value: '500+', icon: Users, change: '+8%', positive: true },
    { label: 'Trading Volume', value: '$2.4M+', icon: BarChart3, change: '+24%', positive: true },
    { label: 'Creator Earnings', value: '$180K+', icon: DollarSign, change: '+18%', positive: true }
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20 z-10">
        ...
        <div className="relative max-w-7xl mx-auto text-center z-10">
          ...
          >
            ...
            <span className="px-2 py-0.5 text-xs font-bold bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full animate-pulse">LIVE</span>
          </motion.div>
          ...
          >
            <Link to="/tokenize">
              <motion.button
                className="group relative px-8 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-2xl text-white font-bold text-lg overflow-hidden shadow-2xl shadow-violet-500/50"
          ...
          >
            {liveStats.map((stat, index) => {
              ...
              return (
                  ...
                  style={{
                    rotateX: index === 0 ? rotateX : undefined,
                    rotateY: index === 0 ? rotateY : undefined,
                    transformStyle: 'preserve-3d'
                  }}
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-violet-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <Icon className="w-8 h-8 text-violet-400 mb-3 relative z-10" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <motion.div 
                    key={i}
                    className="group p-6 rounded-2xl bg-green-500/5 border border-green-500/20 hover:border-green-500/40 transition-all relative overflow-hidden"
                    whileHover={{ x: 10, scale: 1.02 }}
                    initial={{ opacity: 0, x: 20 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
      ...
      <section className="relative py-32 px-4 z-10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Everything you need to launch your creator economy on Algorand blockchain.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 px-4 bg-gradient-to-b from-transparent via-violet-950/20 to-transparent z-10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Launch your creator economy in three simple steps. Built on Algorand for speed and low fees.
            </p>
          </motion.div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              ...
              create prediction markets, and give your fans real value on Algorand blockchain.
            </p>
