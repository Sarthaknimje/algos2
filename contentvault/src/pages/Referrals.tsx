          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xs text-violet-300 font-medium">ALGO</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xs text-fuchsia-300 font-medium">ALGO Traded</p>
              </div>
            </motion.div>
          </motion.div>
        )}
                  ...
                  <tbody>
                    {earnings.referrals.map((ref, idx) => (
                      <tr key={idx} className="border-t border-white/5 hover:bg-white/5 transition-colors">
                        ...
                        <td className="px-4 py-3 text-right text-gray-300">{formatAlgo(ref.total_volume || 0)} ALGO</td>
                        <td className="px-4 py-3 text-right text-emerald-400 font-semibold">{formatAlgo(ref.total_earnings || 0)} ALGO</td>
                  ...
                  <tbody>
                    {earnings.earnings_history.map((earning, idx) => (
                      <tr key={idx} className="border-t border-white/5 hover:bg-white/5 transition-colors">
                        ...
                        <td className="px-4 py-3 text-right text-gray-300">{formatAlgo(earning.trade_value || 0)} ALGO</td>
                        <td className="px-4 py-3 text-right text-emerald-400 font-semibold">{formatAlgo(earning.earnings || 0)} ALGO</td>
