...
export class BondingCurveService {
   ...
   */
  static initialize(
    initialPrice: number = 0.001, // 0.001 ALGO per token
  ...
  static calculateBuyPrice(
    ...
    // ALGO cost = difference in reserves
  ...
  static calculateSellPrice(
    ...
    // ALGO received = difference in reserves
  ...
  /**
   * Calculate how many tokens can be bought with a specific ALGO amount
   */
  ...
  /**
   * Calculate ALGO received for selling a specific token amount
   */
  ...
  static shouldMigrateToAMM(
    ...
    migrationThreshold: number = 50000 // $50k in ALGO
  ): boolean {
