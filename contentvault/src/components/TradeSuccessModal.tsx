...
export const TradeSuccessModal: React.FC<TradeSuccessModalProps> = ({
  ...
  const explorerLink = `https://testnet.explorer.perawallet.app/tx/${transactionId}`
  const assetExplorerLink = assetId ? `https://testnet.explorer.perawallet.app/asset/${assetId}` : null
          ...
          >
            ...
            >
              ...
              >
                ...
                <span>Transaction confirmed on Algorand blockchain!</span>
              </motion.div>
            </motion.div>
          </motion.div>
        )}
